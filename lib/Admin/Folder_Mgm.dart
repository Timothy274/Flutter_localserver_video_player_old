                            ...
                            return new GestureDetector(
                              onTap: ()=>Navigator.of(context).push(
                                  new MaterialPageRoute(
                                      builder: (BuildContext context)=> new Folder_Mgm__Edit_Admin(dataFolder[index].id, dataFolder[index].name, dataFolder[index].path)
                                  )
                              ),
                              child: LimitedBox(
                              maxHeight: 150,
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: (){
          Navigator.of(context).push(
            new MaterialPageRoute(
                builder: (BuildContext context)=> new Folder_Mgm_Add_Admin()
            )
          );
        },
